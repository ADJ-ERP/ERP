...
public class EditPart extends JFrame{
    ...
    public EditPart(PartidaTable partidaTable, PartidaDB partidaDB) {
        this.partidaTable = partidaTable;

        this.partidaDB = partidaDB;
        ...
        addStuffs(
                ...
                costoTotalLabel,
                notasLabel,
                numeroPartidaTextField,
                fechaAltaTextField,
                tipoTextField,
                centroVentaTextField,
                numeroMataderoTextField,
                proveedorTextField,
                numeroExplTextField,
                paisNacimientoTextField,
                paisSacrificioTextField,
                tipoAnimalTextField,
                totalAnimalesTextField,
                delNumTextField,
                alNumTextField,
                totalKGBrutoTextField,
                porOreoTextField,
                totalKGNetoTextField,
                costoTotalTextField,
                notasTextField,
                submitButton
        );
